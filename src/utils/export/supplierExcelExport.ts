/**
 * Supplier Excel Export Utility
 * 
 * Provides Excel export functionality for supplier table data.
 * Uses HTML table format which is compatible with Excel/LibreOffice.
 */

export type SupplierExcelColumn<T> = {
...
/**
 * Exports supplier table data to Excel format (.xls)
 * 
 * @param rows - Array of supplier data rows to export
 ...
 * ```
 */
export const exportSupplierToExcel = <T,>(
  rows: T[],
  columns: SupplierExcelColumn<T>[],
  filename: string
): void => {
...
/**
 * Exports supplier table data to Excel format with custom styling
 * 
 * @param rows - Array of supplier data rows to export
 * @param columns - Column definitions with headers and accessors
 * @param filename - Name of the output file (without extension)
 ...
 * ```
 */
export const exportSupplierToExcelStyled = <T,>(
  rows: T[],
  columns: SupplierExcelColumn<T>[],
  filename: string,
  options: {
