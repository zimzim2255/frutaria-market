// This project uses version-pinned import specifiers in many places (e.g. `sonner@2.0.3`).
// Vite can resolve those via aliases, but TypeScript `tsc` cannot.
// These ambient module declarations map the pinned specifiers to the real packages
// so `npm run typecheck` works.
