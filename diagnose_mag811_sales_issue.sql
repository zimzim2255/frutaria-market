...
-- ============================================
-- This script checks why sales for mag 811 are not showing for admin
-- but are showing for the manager

-- ============================================
-- STEP 1: FIND MAG 811 STORE
-- ============================================
SELECT 
  '=== MAG 811 STORE INFO ===' as section,
  id,
  name,
  email,
  user_id,
...
-- ============================================
-- STEP 2: CHECK SALES FOR MAG 811
-- ============================================
SELECT 
  '=== SALES FOR MAG 811 ===' as section,
  s.id,
  s.sale_number,
  s.store_id,
...
-- ============================================
-- STEP 3: CHECK SALES BY DATE FOR MAG 811
-- ============================================
SELECT 
  '=== MAG 811 SALES BY DATE ===' as section,
...
-- ============================================
SELECT 
  '=== MAG 811 SALES STORE_ID CHECK ===' as section,
...
-- ============================================
SELECT 
  '=== RLS STATUS ON SALES ===' as section,
  schemaname,
  tablename,
  rowsecurity
FROM pg_tables
...
-- ============================================
SELECT 
  '=== ADMIN USER STORE ASSIGNMENT ===' as section,
  u.id,
  u.email,
  u.role,
  u.store_id,
...
-- ============================================
SELECT 
  '=== CAN ADMIN SEE MAG 811? ===' as section,
  CASE 
    WHEN EXISTS (
...
-- ============================================
SELECT 
  '=== SALES WITH MAG 811 STORE_ID ===' as section,
  COUNT(*) as total_sales,
